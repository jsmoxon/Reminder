...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('reminders_reminder', (
            ...
            ('date_to_remind', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
    ...
    models = {
        ...
        'reminders.reminder': {
            ...
            'date_to_remind': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
